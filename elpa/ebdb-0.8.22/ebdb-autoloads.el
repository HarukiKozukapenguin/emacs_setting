...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebdb-mu4e" '("ebdb-mu4e-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebdb-notmuch" '("ebdb-notmuch-")))
...
;;;***

;;;### (autoloads nil "ebdb-roam" "ebdb-roam.el" (0 0 0 0))
;;; Generated autoloads from ebdb-roam.el

(autoload 'ebdb-roam-section "ebdb-roam" "\
...
\(fn NODE &key (HEADING \"Address Book Entries\") (RECORD-FORMATTER ebdb-default-multiline-formatter))" nil nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebdb-roam" '("ebdb-roam--get-links")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebdb-wl" '("ebdb-wl-")))
